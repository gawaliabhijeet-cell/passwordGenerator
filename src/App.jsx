    ...
    <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-4 my-8 text-orange-500 bg-gray-700 text-center'>
        ...
        <div className='flex shadow rounded-lg text-center overflow-hidden mb-4'>
          ...
          <button
            ...
            className={`w-auto font-medium py-2 px-4 rounded-r-lg shadow-md transition-all duration-200 ease-in-out transform hover:scale-[1.01] active:scale-[0.99] focus:outline-none focus:ring-2 focus:ring-opacity-50 ${isCopied ? 'bg-green-600 hover:bg-green-700 text-white focus:ring-green-500'
        ...
        {/* Info Stats Section */}
        <div className='flex justify-around items-center m-4 mt-4 pt-2 border-t border-gray-600 text-white text-sm'>
